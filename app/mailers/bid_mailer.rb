class BidMailer < ApplicationMailer
  ...
  def out_bidded(bid_id, test_email=nil)#code: "template16"
  ...
  def submitted(bid_id, test_email=nil)#code: "template17"
    @offer = Bid.find_by(id: bid_id)
    if @offer
  	  @buyer = User.find_by(id: @offer.user_id)
      @property = Property.find_by(id: @offer.property_id)
  ...
  def highest_bidder_notification(bid_id, test_email=nil)#code: "template19"
    @offer = Bid.find_by(id: bid_id)
    if @offer
  	  @buyer = User.find_by(id: @offer.user_id)
      @property = Property.find_by(id: @offer.property_id)
