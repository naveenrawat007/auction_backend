namespace :show_types do
  ...
  task update: :environment do
    ShowInstructionsType.find_by(name: "Type1").update(description: "There are no inspections of the inside of the property. Users have to bid based upon all of the information provided including a video of the property. This might make it hard to sell your property because most buyers aren’t going to buy a property without seeing the inside.")
    ...
    ShowInstructionsType.where(name: "Type5", description: "Property is vacant and easy to show as long as buyer registers their name, number, date and time of showing before they can get showing information.").first_or_create()
